                    ...
                    <div class="mt-4 md:mt-10 tl-content tl-content-active">
                        ...
                        <div className="tl-body">
                            <ul className='pt-5 pb-7 list-disc px-0 md:px-5'>
                                ...
                                <li className='font-medium text-xs md:text-base font-montserrat text-stone-400'>Collaborated closely with designers and Quality Assurance (QA) professionals to refine design specifications, resulting in a visually polished application.</li>
                                <li className='font-medium text-xs md:text-base font-montserrat text-stone-400'>Conducted code reviews and collaborated with team members to uphold coding standards and ensure high-quality code.</li>
                            </ul>
                        </div>
                    </div>
                    <div className="tl-content tl-content-active">
                        ...
                        <div className="tl-body">
                            <ul className='pt-5 pb-7 list-disc px-0 md:px-5'>
                                ...
                                <li className='font-medium text-xs md:text-base font-montserrat text-stone-400'>I have demonstrated strong collaboration skills by Engaging Closely with Clients, Actively Listening to Discern Unique Project Requirements, and Consistently Delivering Tailored Solutions That Exceed Expectations.</li>
                            </ul> 
                        </div>
                    </div>
