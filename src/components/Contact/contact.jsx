...
export default function contact({contactRef}) {
    return (
        <div className='pt-40' ref={contactRef}>
            ...
            <h1 className='mt-1 font-bold text-2xl font-montserrat text-black'>Don't be shy! Hit me up! <img className='inline w-6 h-6' src={handDown} /></h1>
            <div className='flex gap-20 mt-10'>
                <div className='flex gap-5'>
                    ...
                    <div>
                        ...
                        <a className='pointer mt-4 font-medium text-base font-montserrat text-stone-500'>Staten Island, NY, United States</a>
                    </div>
                </div>
                <div className='flex gap-5'>
