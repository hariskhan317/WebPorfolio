...
export default function TechStack() {
    ...
    return (
        <div className='techstack flex flex-col lg:flex-row justify-center gap-10 mt-10 md:mt-0 px-10 md:px-0 z-30 relative'>
            ...
            <div className='flex gap-8 flex-wrap justify-center'>
                {Skills.map((skill) => (
                    <img src={skill} className='w-8 h-8 md:w-9 md:h-9' alt="skill" />
                ))}
            </div>
        </div>
    )
